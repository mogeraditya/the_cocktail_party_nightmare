...
number_of_simulation_runs =  np.arange(10,100,10)
# radial_distance = [0.2, 0.5, 0.75]
azimuth_location = [np.pi/2] 
radial_values=[1,2,3]
threshold= 0.1
...
i = 0
for number_of_simulation_run in number_of_simulation_runs:
        ...
        for heading_var in group_heading_variation:
            ...
            # for r in radial_distance:
                for theta in azimuth_location:
                    ...
                    simulation_parameters["focal_plus_heading_var"] = (radial_value, theta, heading_var)
                    ...
                    all_params = [group_size,interpulse_duration, call_duration, shadowing,
                                    ...
                                    atmospheric_absorption, group_size, threshold, 
                                    theta, radial_value, heading_var]
